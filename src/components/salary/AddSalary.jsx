...
const AddSalary = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        try{
            const response = await axios.post(`https://worksphere-backend.vercel.app/api/salary/addSalary`, salary, {
            headers: {
            ...
            {/**Department */}
               ...
               <div>
                ...
                <div>
                    ...
                    <input  type="number" name="deductions" onChange={handleChange} placeholder="deduction"
                    className="mt-1 p-2 block w-full border-gray-300 rounded-md" required />
                </div>
